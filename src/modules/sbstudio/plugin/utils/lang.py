...
translation_zh_CN = {
    ...
    ("*", "Path") : "路径",
    ("*", "Path of the imported PNG images") : "导入的png图片路径",
    ("*", "The minimum distance for imported PNG") : "导入的png最小距离",
    ...
    ("*", "Select PNG image") : "选择PNG图片",
    ("Operator", "Select PNG image") : "选择PNG图片",
    ("*", "Calculate path:") : "计算路径：",
    ...
    ("*", "From static CSV file") : "从静态CSV文件",
    ("*", "From zipped CSV files") : "从压缩CSV文件",
    ("*", "From SVG file") : "从SVG文件",
    ("*", "From QR Code") : "从二维码",
    ("*", "Whether the transition is locked. Locked transitions are never re-calculated") : "过渡是否已锁定，锁定的过渡永远不会重新计算",
