...
translation_zh_CN = {
    ...
    ("*", "Maximum xy velocity of all drones in the current frame") : "当前帧中所有无人机的最大 xy 速度",
    ...
    ("*", "Maximum z velocity of all drones in the current frame") : "当前帧中所有无人机的最大 z 速度",
    ("*", "Max XY acceleration") : "最大XY加速度",
    ("*", "Maximum xy acceleration allowed when planning the duration of transitions between fixed points") : "规划固定点之间过渡持续时间时允许的最大 xy 加速度",
    ("*", "Max Z acceleration") : "最大Z加速度",
    ("*", "Maximum z acceleration allowed when planning the duration of transitions between fixed points") : "规划固定点之间过渡持续时间时允许的最大 z 加速度",
    ...
    ("*", "Zoom Ratio") : "缩放倍率",
    ("*", "The maximum ratio to which the drone can eventually zoom") : "无人机最终可缩放到的最大倍率",
    ...
    ("*", "Framerate") : "帧率",
    ("*", "Distance Result") : "距　离",
    ("*", "XY Velocity Result") : "XY速度",
    ("*", "Z Velocity Result") : "Z 速度",
    ("*", "XY Acceleration Result") : "XY加速度",
    ("*", "Z Acceleration Result") : "Z 加速度",
    ...
    ("*", "Column spacing") : "列间距",
    ("*", "Spacing between the columns of the slots in the grid") : "网格中槽列之间的间距",
    ("*", "Intra-slot rows") : "槽内行数",
    ("*", "Intra-slot columns") : "槽内列数",
    ("*", "Intra-slot row spacing") : "槽内行距",
    ("*", "Intra-slot column spacing") : "槽内列距",
    ("*", "Layer height") : "层高",
    ("*", "Layer height between the layer in the grid") : "网格中各层之间的层高",
    ...
    ("Operator", "Recalculate group takeoff path") : "重新计算分组起飞路径",
    ...
    ("Operator", "Nebula") : "星云",
    ("*", "Calculating nebula takeoff and landing") : "计算星云起飞与降落",
    ("*", "Takeoff frame") : "起飞帧",
    ("*", "The frame where the drone starts taking off") : "无人机开始起飞的帧",
    ("*", "Shape frame") : "造型帧",
    ("*", "The initial frame of the nebula taking flight") : "星云飞舞的起始造型帧",
    ("*", "XY Velocity") : "XY向速度",
    ("*", "Landing height") : "着陆高度",
